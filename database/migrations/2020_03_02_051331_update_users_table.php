...
class UpdateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            $table->string('user_url')->comment('The link to user profile page')->after('password');
            $table->string('user_activation_key')->nullable()->after('user_url');
            $table->string('user_status')->comment('1:active, 2:inactive, 3:pending, 4:suspended, 5:dropped')->after('user_activation_key');
